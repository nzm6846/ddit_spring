...
public class FirstController {
    ...
    */
    ...
    public String index(Model model){
        ...
        //첫째, 캐스팅(형변환). Iteratable, Collection, LList 인터페이스의 상하 관계는
    ...
    public String update(ArticleForm form){
        ...
        Optional<Article> target = this.articleRepository.findById(articleEntity.getId());
