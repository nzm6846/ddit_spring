...
처리해야 할지 알려 주는 추가 정보. 자바에서 어노테이션은 앞에 골뱅이 기호를 붙여 사용.
 */
...
public class FirstController {
    ...
    public ModelAndView niceToMeetYou(){
        ...
        //model 객체가 "한얼" 값을 "username"속성에 연결해 웹 브라우저로 보냄
        mav.addObject("username","한얼");
        mav.addObject("myfriend","민기");
    ...
    public String seeYouNext(Model model){//2. 메서드 작성 : /bye 요청을 처리
        ...
        //mav.addObject("속성","값");
        model.addAttribute("nickname","개똥이");
    ...
    */
    ...
    @PathVariable 어노테이션을 사용하여 URL 경로의 id 값을 Long 타입의 id 매개변수로 가져옵니다.
    RedirectAttributes는 리다이렉트 시 데이터를 전달하기 위해 사용됩니다.
     */
    @GetMapping("/articles/{id}/delete")
    public String delete(@PathVariable(value="id") Long id,
                         RedirectAttributes rttr){
        // 로그: 삭제 요청이 수신되었음을 기록합니다.
        log.info("삭제 요청이 들어옴. id : " + id);
